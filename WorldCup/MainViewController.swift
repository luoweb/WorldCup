...
class MainViewController: UITabBarController {
    ...
    let itemArray = ["Player","Match","Team","Shooter"]
...
//        var board = UIStoryboard(name: "MainViewController", bundle: nil)
//        var next = board.instantiateViewControllerWithIdentifier("NewsViewController")
//        var vc1 = PlayerViewController()
//        uisto
//        var vc2 = NewsViewController()
//        var vc3 = MatchViewController()
//        var vc4 = TeamViewController()
        
//        self.viewControllers = [vc2,vc4,vc1,vc3]
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        var newsVC = segue.destinationViewController as NewsViewController
//        newsVC.useLayoutToLayoutNavigationTransitions = true
    }
